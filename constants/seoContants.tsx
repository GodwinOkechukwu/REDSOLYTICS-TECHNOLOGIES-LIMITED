...
export const SITE_NAME = "REDSOLYTICS TECHNOLOGIES LIMITED";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "REDSOLYTICS TECHNOLOGIES LIMITED cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "REDSOLYTICS TECHNOLOGIES LIMITED",
