...
import spill from "../../../../public/images/bluespill.png";
import print from "../../../../public/images/blueprint.png";
...
const HomeProductCard = ({ product }: { product: ProductType }) => {
  ...
  const compareCount = useSelector(
    (state: RootState) => state.compare.items.length,
  );
  ...
  return (
    <>
      <PopularProductsSection
        ...
        title="Best Sellers"
        description="Discover our curated collection of best sellers – handpicked favorites loved by our customers for their exceptional quality, performance, and value."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Get your next <br className="hidden sm:block" />
                must-have Gadget
              </h1>

              <p className="mt-6 text-gray-600 text-base lg:text-lg max-w-lg">
                Collect the innovation you love. Explore our curated selection
                of high-tech wonders, designed to elevate your daily life and
                inspire your passions.
              </p>
              ...
              <button
                ...
                className="mt-8 inline-flex items-center gap-2 bg-shop hover:bg-shop/90 text-white px-6 py-3 rounded-lg font-medium transition"
              >
                Buy Now
            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              <Picture
                src={spill}
                alt={"spill"}
                className="absolute w-[90%] max-w-md top-10 right-4 lg:right-10"
              />
